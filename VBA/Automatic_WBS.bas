...
On Error Resume Next
  ...
  Do
    ...
    Call InsertRectangle(wbsCode, caption, p.x, p.y, w, h, level, progress, linkedDocuments)
...
Sub InsertRectangle(name As String, caption As String, x As Double, y As Double, w As Double, h As Double, level As Integer, progress As Double, linkedDocuments As String)
Dim s As String
Dim c As Long
Dim id As String
